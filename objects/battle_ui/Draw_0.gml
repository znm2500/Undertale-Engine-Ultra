if (global.kr) {
    ...
    draw_sprite_ext(spr_pixel, 0, x + 245 + Player_GetHp() * 1.25, y - 1, Player_GetKr() * 1.25, 20, 0, color, 1) draw_text_ext_transformed_color(x + 245 + Player_GetHpMax() * 1.25 + 14, y, "    " + string((Player_GetHp() + Player_GetKr())) + " / " + string(Player_GetHpMax()), -1, -1, 1, 1, 0, color, color, color, color, 1);
