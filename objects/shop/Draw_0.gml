...
switch(_state)
{
	case SHOP_STATE.MENU:
		draw_sprite_ext(spr_battle_soul,0,menu_divide_x + 24,border_y1 + 18.5 + 20*_index,0.5,0.5,90,c_red,1);
		break;
	case SHOP_STATE.BUY:
		if(_choice_state == 1)
			draw_sprite_ext(spr_battle_soul,0,menu_divide_x + 16,border_y1 + 52.5 + 17*_index_buy,0.5,0.5,90,c_red,1);
		else
			draw_sprite_ext(spr_battle_soul,0,border_x1 + 16,border_y1 + 18.5 + 20*_index,0.5,0.5,90,c_red,1);
		break;
	case SHOP_STATE.SELL:
		if(_host.sold_available){
			...
			draw_sprite_ext(spr_battle_soul,0,X+4,Y+4,0.5,0.5,90,c_red,1);
		}
		
		break;
	case SHOP_STATE.DIALOG:
		if(_dialog == false)
			draw_sprite_ext(spr_battle_soul,0,border_x1 + 18,border_y1 + 18.5 + 20*_index,0.5,0.5,90,c_red,1);
		break;
	default:
		break;
}
