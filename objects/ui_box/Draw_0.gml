...
if (_state == 0) {
    draw_sprite_ext(spr_pixel, 0, (320 - _show_width) / 2, 8, _show_width, 225, 0, c_white, 1);
    draw_sprite_ext(spr_pixel, 0, (320 - (_show_width >= 6 ? _show_width - 6 : 0)) / 2, 11, _show_width >= 6 ? _show_width - 6 : 0, 225 - 3 * 2, 0, c_black, 1);
    surface_set_target(_surface) draw_sprite_ext(spr_pixel, 0, (8 + 3 + 149.5) * 2, (8 + 3 + 36) * 2, 1, 300, 0, c_white, 1);
    ...
    draw_sprite_ext(spr_battle_soul, 0, (8 + 3 + 13.5 + 151 * _choice_mode_soul) * 2, (8 + 3 + 34.5 + 16 * _choice_item_soul) * 2, 1, 1, 90, c_red, 1);
