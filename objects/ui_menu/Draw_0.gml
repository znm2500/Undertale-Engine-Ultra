...
if (_menu==1) {
	surface_set_target(_surface)
    draw_sprite_ext(spr_battle_soul, 0, (94+3+11)*2, (26+3+20+16*_choice_phone_soul)*2,1,1, 90, c_red, 1);
    surface_reset_target()
}

if (_menu==2) {
	surface_set_target(_surface)
    draw_sprite_ext(spr_battle_soul, 0, (94+3+_choice_item_operate_soul)*2,(26+3+159.5)*2, 1, 1, 90, c_red, 1);
	surface_reset_target()
...
for(var i=0;i<2;i++){if(_show_width[i]!=0)break}
