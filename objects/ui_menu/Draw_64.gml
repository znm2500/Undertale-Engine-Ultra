...
if(_menu==0){
	draw_sprite_ext(spr_battle_soul,0,32+6+27,168+6+31+36*_choice,1,1,0,c_red,1);
}
...
if(_menu==1){
	draw_sprite_ext(spr_battle_soul,0,188+6+23,52+6+39+32*_choice_item,1,1,0,c_red,1);
}
...
if(_menu==2){
	...
	draw_sprite_ext(spr_battle_soul,0,188+6+X,52+6+319,1,1,0,c_red,1);
}
...
if(_menu==4){
	...
	draw_sprite_ext(spr_battle_soul,0,188+6+23,52+6+39+32*_choice_phone,1,1,0,c_red,1);
}