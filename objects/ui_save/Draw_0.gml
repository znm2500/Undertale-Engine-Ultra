...
draw_surface_part_ext(_surface, 320 - (_show_width >= 6 ? _show_width - 6 : 0), 0, (_show_width >= 6 ? _show_width - 6 : 0) * 2, 480, camera.x + 160 - (_show_width >= 6 ? _show_width - 6 : 0) / 2, camera.y, 0.5, 0.5, c_white, 1);
surface_set_target(_surface);
